/**
 * Variants for the Toggle component, using class-variance-authority (cva).
 *
 * @see Toggle (ui/toggle.jsx)
 * @type {import("class-variance-authority").VariantProps}
 */
import { cva } from "class-variance-authority";

/**
 * toggleVariants provides style variants for the Toggle component.
 *
 * @example
 *   <Toggle className={toggleVariants({ variant: 'outline', size: 'sm' })} />
 */
