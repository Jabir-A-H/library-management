...
/**
 * Returns the className string for a NavigationMenu trigger button, using class-variance-authority (CVA).
 *
 * This utility is used to ensure consistent styling for all navigation menu triggers.
 *
 * @example
 *   <NavigationMenuTrigger className={navigationMenuTriggerStyle()} />
 *
 * @returns {string} The composed className string for the trigger.
 */
